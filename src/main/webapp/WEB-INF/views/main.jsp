        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item">
              ...
              <div class="offcanvas offcanvas-end" tabindex="-1" id="anotherOffcanvas" aria-labelledby="offcanvasNavbarLabel">
              <div class="offcanvas-header">
...
<button type="button" class="btn btn-outline-primary" ><i class="bi bi-trash-fill"></i>삭제</button> <!-- 즐겨찾기 삭제 -->
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#">스케줄 History</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#">여행 일지</a>
            </li>
          </ul>
        </div>
      </div>
...
//이벤트 리스너 추가
    ...
    $(document).ready(function() {
        ...
        $('#Favorites').click(function() {
            $('#anotherOffcanvas').offcanvas('show');
        });
    });
</script>
